...
/*  ══════════════════════════════════════════════════════════
   JURATONE PRO v8.7.0 — Édition Expert (Belgique)
   Patch v8.7.0 (avril 2026) :
   1. JURISPRUDENCE — Ajout de 3 sources officielles :
      - Lex.be (plateforme gratuite full-text)
      - BelgiqueLex (Banque Carrefour interinstitutionnelle)
      - Reflex (Conseil d'État, base relationnelle)
   2. LÉGISLATION — Ajout de 5 sources :
      - EUR-Lex (droit UE, Journal officiel faisant foi)
      - DroitBelge.net Codes (codes consolidés gratuits)
      - Gallilex (Communauté française / FWB)
      - Lex.be (législation full-text)
      - Livre IX Code civil — Sûretés (en vigueur 01/01/2026)
   3. INDEXATION — Données officielles Statbel étendues :
      - De Mars 2024 à Mars 2026 (25 mois)
...
      - Wallonie : barèmes tranches corrigées (25k/50k/175k/250k/500k)
        Source : Code des droits de succession wallon art. 60ter
      - Bruxelles : barèmes tranches corrigées (50k/100k/175k/250k)
        Source : notaire.be + Code droits succession RBC
   5. Ajout notes documentaires : réforme Wallonie 2028, Flandre 2026,
...
//  ═══  DONNÉES & CONSTANTES  ═══
//  🔴  PATCH v8.7.0 : Ajout de Lex.be, BelgiqueLex, Reflex Conseil d'État
const JURIS = [
...
  { id: "j1", title: "Juridat (Archives)", desc: "Ancienne base de la Cour de cassation (remplacée progressivement par Juportal).", url: "https://www.juridat.be", cat: "Officiel" },
  { id: "j3", title: "Cour constitutionnelle", desc: "Arrêts du Grondwettelijk Hof / Cour constitutionnelle.", url: "https://www.const-court.be", cat: "Cour" },
...
  { id: "j9", title: "Reflex (Conseil d'État)", desc: "Base relationnelle officielle : travaux parlementaires, chronos législatifs, jurisprudence, avec liens vers Justel, Moniteur, EUR-Lex.", url: "https://www.raadvst-consetat.be/?page=caselaw&lang=fr", cat: "Cour" },
  { id: "j7", title: "Lex.be", desc: "Plateforme gratuite full-text (type Google) : +1 million de documents de législation et jurisprudence belges. Accès libre et universel.", url: "https://www.lex.be", cat: "Gratuit" },
  { id: "j8", title: "BelgiqueLex — Banque Carrefour", desc: "Portail interinstitutionnel (Chambre, Sénat, Cassation, Cour constitutionnelle, Conseil d'État, Gouvernement fédéral). Accès unifié à la législation et à la jurisprudence.", url: "https://belgiquelex.be/fr/jurisprudence/", cat: "Officiel" },
  { id: "j5", title: "CJUE — InfoCuria", desc: "Cour de justice de l'Union européenne.", url: "https://curia.europa.eu/juris/recherche.jsf?language=fr", cat: "Européen" },
  { id: "j6", title: "CEDH — HUDOC", desc: "Cour européenne des droits de l'homme.", url: "https://hudoc.echr.coe.int", cat: "Européen" },
];
const DOC_PLATFORMS = [
  { id: "d1", title: "Strada lex", desc: "Doctrine et législation belges (Larcier-Intersentia).", url: "https://www.stradalex.com", cat: "Plateforme", acc: "Abonnement payant / Uni" },
  { id: "d2", title: "Jura (Wolters Kluwer)", desc: "Législation, jurisprudence et doctrine.", url: "https://jura.kluwer.be", cat: "Plateforme", acc: "Abonnement payant / Uni" },
  { id: "d3", title: "Jurisquare", desc: "Bibliothèque numérique juridique belge.", url: "https://www.jurisquare.be", cat: "Plateforme", acc: "Payant à l'acte / Uni" },
  { id: "d4", title: "CAIRN.info — Droit", desc: "Revues académiques francophones.", url: "https://www.cairn.info/disc-droit.htm", cat: "Plateforme", acc: "Accès partiel gratuit" },
];
const DOC_BIBLIO = [
  { id: "b1", title: "Droit des obligations", author: "P. Van Ommeslaghe", ed: "Bruylant", mat: "Civil", niv: "Niveau 3 - Recherche", type: "Traité", desc: "Référence absolue en droit des obligations belge." },
  { id: "b2", title: "Traité de droit civil belge", author: "H. De Page", ed: "Bruylant", mat: "Civil", niv: "Niveau 3 - Recherche", type: "Traité", desc: "Monument du droit civil belge." },
  { id: "b3", title: "Manuel de droit civil", author: "Y.-H. Leleu", ed: "Larcier", mat: "Civil", niv: "Niveau 1 - Étudiant", type: "Manuel", desc: "Introduction claire et structurée." },
  { id: "b4", title: "Droit pénal général", author: "F. Tulkens et al.", ed: "Larcier", mat: "Pénal", niv: "Niveau 1 - Étudiant", type: "Manuel", desc: "Manuel universitaire classique." },
  { id: "b5", title: "Les infractions (5 vol.)", author: "A. De Nauw, F. Kuty", ed: "Larcier", mat: "Pénal", niv: "Niveau 2 - Pratique", type: "Code commenté", desc: "Analyse exhaustive de chaque infraction." },
  { id: "b6", title: "Droit judiciaire", author: "G. de Leval, F. Georges", ed: "Larcier", mat: "Judiciaire", niv: "Niveau 2 - Pratique", type: "Traité", desc: "Référence sur la procédure civile." },
  { id: "b7", title: "Manuel de droit des sociétés", author: "Y. De Cordt", ed: "Larcier", mat: "Sociétés", niv: "Niveau 1 - Étudiant", type: "Manuel", desc: "À jour du CSA/WVV (2019)." },
];
...
const LEGIS = [
  { id: "l1", title: "Justel — Législation consolidée", desc: "Textes légaux belges consolidés (SPF Justice).", url: "https://www.ejustice.just.fgov.be/cgi_loi/loi.pl", cat: "Source officielle" },
  { id: "l2", title: "Moniteur belge", desc: "Publications officielles journalières.", url: "https://www.ejustice.just.fgov.be/cgi/welcome.pl", cat: "Source officielle" },
...
  { id: "l10", title: "Lex.be — Législation", desc: "Alternative gratuite à Justel : législation consolidée belge avec moteur de recherche full-text. Accès libre et universel.", url: "https://www.lex.be", cat: "Gratuit" },
  { id: "l4", title: "Réforme du Code civil — vue d'ensemble", desc: "Nouveaux Livres en vigueur (SPF Justice).", url: "https://justice.belgium.be/fr/themes_et_dossiers/droit_civil/nouveau_code_civil", cat: "Code" },
  { id: "l6", title: "DroitBelge.net — Codes consolidés", desc: "Accès gratuit aux codes belges : nouveau Code civil (Livres I à IX), ancien Code civil, Code judiciaire, Code pénal, CSA, CIR92, etc.", url: "https://www.droitbelge.be/codes.asp", cat: "Code" },
  { id: "l11", title: "Code civil — Livre IX (Sûretés)", desc: "Nouveau Livre IX du Code civil relatif aux sûretés (cautionnement, gages, privilèges, hypothèques). En vigueur depuis le 1er janvier 2026.", url: "https://www.droitbelge.be/codes.asp", cat: "Code" },
  { id: "l4b", title: "Ancien Code civil (1804)", desc: "Dispositions résiduelles non encore réformées.", url: "https://www.ejustice.just.fgov.be/cgi_loi/change_lg.pl?language=fr&la=F&cn=1804032130&table_name=loi", cat: "Code" },
  { id: "l7", title: "Code des sociétés et des associations (CSA / WVV)", desc: "En vigueur depuis 2019.", url: "https://www.ejustice.just.fgov.be/cgi_loi/change_lg.pl?language=fr&la=F&cn=2019032309&table_name=loi", cat: "Code" },
  { id: "l8", title: "Wallex / Vlaamse Codex", desc: "Législation régionale (Wallonie / Flandre).", url: "https://wallex.wallonie.be/", cat: "Régional" },
  { id: "l9", title: "Gallilex (Fédération Wallonie-Bruxelles)", desc: "Législation consolidée de la Communauté française : décrets, arrêtés du Gouvernement, arrêtés ministériels, circulaires, actes de (sub)délégation.", url: "https://gallilex.cfwb.be/", cat: "Régional" },
  { id: "l5", title: "EUR-Lex", desc: "Accès officiel au droit de l'Union européenne : traités, règlements, directives, textes consolidés, jurisprudence CJUE, Journal officiel UE (seule édition faisant foi depuis 2013).", url: "https://eur-lex.europa.eu/homepage.html?locale=fr", cat: "Européen" },
];
const CHECKS = [
  { id: "cl1", title: "Achat immobilier",
    options: [{ id: "copro", l: "Le bien est en copropriété (Appartement)" }, { id: "credit", l: "Achat via crédit hypothécaire" }, { id: "loue", l: "Le bien est actuellement loué" }],
    items: [
      { l: "Carte d'identité (Vendeur et Acheteur)" },
      { l: "Compromis de vente signé (Commun)" },
      { l: "Titre de propriété actuel (Vendeur)" },
      { l: "Certificat PEB valide (Vendeur)" },
      { l: "Attestation de sol (Vendeur)" },
      { l: "Renseignements urbanistiques (Vendeur)" },
      { l: "Dossier d'intervention ultérieure (DIU) (Vendeur)" },
      { l: "Preuve de financement / Offre de la banque (Acheteur)", cond: "credit" },
      { l: "Copie du bail en cours et état des lieux (Vendeur)", cond: "loue" },
      { l: "PV des 3 dernières AG de copropriété (Vendeur/Syndic)", cond: "copro" },
      { l: "Décompte des charges et fonds de réserve (Syndic)", cond: "copro" }
    ]
  },
  { id: "cl3", title: "Succession (Premières démarches)",
    options: [{ id: "immo", l: "Le défunt possédait de l'immobilier" }, { id: "testament", l: "Un testament est connu" }],
    items: [
      { l: "Extrait de l'acte de décès (Commune)" },
      { l: "Cartes d'identité de tous les héritiers présumés" },
      { l: "Relevés de tous les comptes bancaires à la date du décès" },
      { l: "Copie du testament ou acte de donation", cond: "testament" },
      { l: "Titres de propriété des biens immobiliers", cond: "immo" },
      { l: "Contrats d'assurance-vie et factures de frais funéraires" }
    ]
  },
];
const GUIDE_SECTIONS = [
  { id: "g-juris", title: "Jurisprudence", category: "juridique", intro: "La section Jurisprudence regroupe les liens directs vers les bases de données officielles de jurisprudence belge et européenne. Depuis v8.7.0 : Lex.be, BelgiqueLex et Reflex ont été  ajoutés.", steps: ["Identifiez la juridiction concernée.", "Pour les décisions récentes : Juportal (moteur SPF Justice) ou Lex.be (gratuit, full-text).", "Pour un panorama institutionnel : BelgiqueLex (Banque Carrefour).", "Pour les aspects administratifs : Reflex (Conseil d'État).", "Pour les droits fondamentaux : HUDOC (CEDH) en parallèle."], tips: ["Commencez par Juportal ou Lex.be pour la jurisprudence publique.", "Les arrêts de la Cour constitutionnelle sont numérotés par année.", "Reflex relie chaque arrêt aux travaux parlementaires correspondants."], pitfalls: ["Ne confondez pas un arrêt de cassation avec un jugement de première instance.", "La jurisprudence belge n'est pas un système de précédent obligatoire."] },
  { id: "g-doctrine", title: "Doctrine", category: "juridique", intro: "La section Doctrine propose trois niveaux : plateformes, bibliothèque et controverses.", steps: ["Plateformes : Strada lex et Jura sont les plus complets mais payants.", "Bibliothèque : filtrez par matière et par niveau.", "Controverses : chaque fiche présente deux positions opposées."], tips: ["Les ouvrages 'Étudiant' sont des manuels structurés.", "Les controverses sont fréquemment posées en examen."], pitfalls: ["Ne vous limitez pas à un seul auteur.", "Vérifiez toujours l'édition."] },
  { id: "g-legis", title: "Législation", category: "juridique", intro: "Liens vers les textes légaux officiels. v8.7.0 ajoute EUR-Lex, DroitBelge.net, Gallilex, Lex.be, et le nouveau Livre IX du Code civil (sûretés, en vigueur depuis 01/01/2026).", steps: ["Pour la législation fédérale belge : Justel, Lex.be (gratuit), ou DroitBelge.net pour les codes consolidés.", "Pour les textes récents : Moniteur belge (publication officielle).", "Pour le droit UE : EUR-Lex (Journal officiel faisant foi).", "Pour le régional : Vlaamse Codex, Wallex (général), Gallilex (FWB / Communauté française)."], tips: ["Justel reste la référence, Lex.be est une excellente alternative gratuite.", "SenLex est utile pour la Constitution et les normes institutionnelles.", "EUR-Lex depuis 2013 : seule l'édition électronique du JO fait foi."], pitfalls: ["Ne citez jamais un article sans vérifier la version consolidée à jour.", "Pas de hiérarchie entre loi fédérale et décret régional dans leurs domaines respectifs.", "Le Livre IX du Code civil (sûretés) a remplacé de nombreuses dispositions au 01/01/2026 : vérifiez la date."] },
  { id: "g-immo", title: "Frais d'achat immobilier", category: "outils", intro: "Estimez le coût total de l'achat d'un bien immobilier en Belgique.", steps: ["Entrez le prix d'achat convenu.", "Sélectionnez la région du bien.", "Cochez les conditions légales pour les taux réduits.", "Cliquez sur Calculer."], tips: ["Les honoraires du notaire sont fixés par arrêté royal.", "Le taux flamand à 2 % (depuis 2025, conditions durcies en 2026) suppose notamment un achat par personnes physiques, en pleine propriété, pour l'habitation propre et unique, avec inscription dans les 3 ans et maintien au moins 1 an.", "À Bruxelles, l'abattement est de 200.000 EUR pour les biens jusqu'à 600.000 EUR."], pitfalls: ["L'administration peut requalifier le prix.", "L'acquisition scindée (usufruit/nue-propriété) exclut le taux réduit en Flandre depuis 2026."] },
  { id: "g-succession", title: "Droits de succession", category: "outils", intro: "Estimation des droits de succession par région et lien de parenté. v8.7.0 : barèmes logement familial corrigés pour la Wallonie et Bruxelles (conformément aux sources notariales officielles).", steps: ["Entrez le montant hérité net.", "Sélectionnez la région du dernier domicile du défunt.", "Choisissez le lien de parenté.", "Cliquez sur Calculer."], tips: ["Les droits s'appliquent par tranche progressive.", "Le logement familial peut être exonéré sous conditions régionales.", "Déclaration : 4 mois (Belgique), 5 mois (Europe), 6 mois (hors Europe).", "Wallonie : réforme 2028 réduira les taux max (30%→15% ligne directe).", "Flandre 2026 : exonération mobilière partenaire passe de 50k à 75k EUR."], pitfalls: ["Le calcul ne tient pas compte des assurances-vie.", "Le calcul ne vaut que si la valeur saisie correspond exclusivement à la part nette concernée par le régime applicable."] },
  { id: "g-routier", title: "Infractions routières", category: "outils", intro: "Estimation de l'amende de perception immédiate pour un excès de vitesse.", steps: ["Entrez la vitesse constatée par le radar.", "Sélectionnez la limite de zone.", "Sélectionnez le type de voirie.", "Cliquez sur Simuler."], tips: ["La perception immédiate est une transaction : si vous payez, l'affaire est close.", "Une redevance administrative en sus s'applique (montant variable)."], pitfalls: ["Au-delà du seuil, le dossier est transmis au parquet.", "La marge technique (6 km/h sous 100, 6% au-dessus) n'est pas déduite."] },
  { id: "g-preavis", title: "Simulateur de préavis", category: "outils", intro: "Calcul du délai de préavis selon le barème SPF Emploi. Calcul exact pour les contrats post-2014, estimation indicative pour les contrats pré-2014.", steps: ["Entrez la date de début du contrat.", "Sélectionnez le mode de notification. Le délai commence le lundi suivant.", "Entrez votre salaire brut ANNUEL complet.", "Sélectionnez Licenciement ou Démission.", "Cliquez sur Calculer."], tips: ["L'indemnité de rupture = le salaire dû si licenciement sans préavis.", "La démission est strictement plafonnée à 13 semaines.", "La lettre recommandée prend effet le 3e jour ouvrable après l'expédition."], pitfalls: ["Le préavis commence TOUJOURS le lundi suivant la date d'effet.", "L'ancienneté se calcule jusqu'à la veille de la prise de cours du préavis.", "Entrez le salaire brut ANNUEL, pas mensuel."] },
  { id: "g-indexation", title: "Module d'indexation", category: "outils", intro: "Calcul d'indexation basé sur l'Indice Santé Statbel. Données officielles étendues de Mars 2024 à Mars 2026 (v8.7.0). Base 2013=100. NB : depuis janvier 2026, Statbel utilise la nouvelle base 2025=100 pour ses publications officielles ; les valeurs 2026 affichées ici sont converties via le coefficient officiel 0,7376 pour la cohérence.", steps: ["Chargez le jeu de données officiel 2024-2026.", "Entrez le montant de base.", "Sélectionnez la région et le PEB pour les vérifications de blocage.", "Cliquez sur Calculer."], tips: ["Pour les baux, l'indexation ne peut se faire qu'une fois par an.", "À Bruxelles, certaines indexations supposent un bail enregistré et un certificat PEB valide communiqué. En Wallonie, le calcul peut devenir spécifique selon le PEB et la date pertinente du bail.",  "L'indice pivot dépassé en décembre 2025 = coefficient de majoration 2,1647 applicable depuis mars 2026."], pitfalls: ["Les données officielles sont issues de Statbel (API JSON) ; vérifiez pour les mois très récents.", "En Flandre post-2019, l'indice de base est le mois précédant l'entrée en vigueur.", "Coefficient de conversion 2013→2025 : x 0,7376 (pour l'indice santé)."] },
];
//  ═══  ALGORITHMES  ═══
...
//  🔴  PATCH v8.7.0 : CORRECTION des barèmes officiels logement familial
// Sources : notaire.be (Fednot), Code droits succession wallon art. 60ter, 
//           Code droits succession RBC.
// 
// Barème WALLONIE (ligne directe, logement familial, après exonération conjoint) :
//   0 - 25.000€     : 1%
//   25.000 - 50.000 : 2%
//   50.000 - 175.000: 5%   (tranches 50-160k et 160-175k fusionnées, même taux)
//   175.000 - 250.000: 12%
//   250.000 - 500.000: 24%
//   > 500.000       : 30%
// 
// Barème BRUXELLES (ligne directe, logement familial, plafond 250.000€ pour réduit) :
//   0 - 50.000€     : 2%
//   50.000 - 100.000: 5,3%
//   100.000 - 175.000: 6%
//   175.000 - 250.000: 12%
//   > 250.000 : tarif normal s'applique (plafond du tarif réduit)
...
    { max: 175000, r: 0.06  },
    { max: 250000, r: 0.12  },
    { max: Infinity, r: 0.12  }  // Plafond : le tarif réduit ne s'applique que jusqu'à 250.000€
  ];
  const bars = reg === "wallonie" ? BR_WAL : reg === "bruxelles" ? BR_BRU : null;
  if (!bars) return null;
  let tax = 0, prevMax = 0;
  // Bruxelles : plafond strict à 250.000€ pour l'application du tarif réduit
...
  const tribFine = grave ? "Dossier transmis au parquet (sanctions judiciaires probables)" : `Risque tribunal : De ${80 * 8} EUR à ${250 * 8} EUR (décimes inclus)`;
  const dech = grave ? "Retrait immédiat et/ou déchéance possibles" : over > 20 && isAgglo ? "Possible (à l'appréciation du juge)" : "Faible (sauf récidive)";
...
  if (a[0] === "Employé CDD") { travail = 7; recs.push({ z: "Travail", t: "Vérifiez les clauses de rupture et de renouvellement de votre CDD." }); }
  if (a[0] === "Indépendant") { travail = 5; fiscal = 6; recs.push({ z: "Fiscal & Statut", t: "Assurez-vous d'avoir une assurance revenu garanti et une protection juridique." }); }
  if (a[1] === "Marié(e)" && a[3] === "Pas de contrat") { famille = 6; recs.push({ z: "Famille", t: "Sans contrat, vous êtes soumis au régime légal. Consultez un notaire." }); }
  if (a[1] === "Cohabitant(e) de fait") { famille = 7; recs.push({ z: "Famille", t: "La cohabitation de fait n'offre aucune protection successorale automatique. Un testament est recommandé." }); }
  if (a[4] === "Oui, avec crédit") { immo = 5; recs.push({ z: "Immobilier", t: "Vérifiez que votre assurance solde restant dû couvre la totalité du capital." }); }
  if (a[7] === "Non") { succession = 7; recs.push({ z: "Succession", t: "Sans testament, la dévolution légale stricte s'applique. Une planification peut optimiser la fiscalité." }); }
  if (recs.length === 0) recs.push({ z: "Général", t: "Votre profil de risque est faible. Maintenez vos documents à jour." });
...
const J_QUESTIONS = [
  { q: "Situation professionnelle", opts: ["Employé CDI", "Employé CDD", "Indépendant", "Fonctionnaire", "Sans emploi"] },
  { q: "Situation familiale", opts: ["Marié(e)", "Cohabitant(e) légal(e)", "Cohabitant(e) de fait", "Célibataire"] },
  { q: "Enfants à charge", opts: ["Aucun", "1-2 enfants", "3+ enfants"] },
  { q: "Régime matrimonial", opts: ["Légal (communauté)", "Séparation de biens", "Pas de contrat", "Ne sait pas"] },
  { q: "Propriétaire immobilier", opts: ["Oui, avec crédit", "Oui, sans crédit", "Locataire"] },
  { q: "Véhicule", opts: ["Oui, +15.000 km/an", "Oui, -15.000 km/an", "Non"] },
  { q: "Gérant/administrateur de société", opts: ["Oui", "Non"] },
  { q: "Testament rédigé", opts: ["Oui", "Non"] },
];
//  ═══  COMPOSANTS  ═══
...
  const [sR, setSR] = useState("bruxelles"); const [sRel, setSRel] = useState("Conjoint / Cohabitant légal");
...
  const succRels = ["Conjoint / Cohabitant légal", "Cohabitant de fait (Flandre)", "Cohabitant de fait (Bruxelles)", "Ligne directe (Enfants/Parents)", "Frère/Sœur", "Oncle/Tante/Neveu/Nièce", "Autres"];
  const relMap = { "Conjoint / Cohabitant légal": "Conjoint/Ligne directe", "Cohabitant de fait (Flandre)": "Conjoint/Ligne directe", "Cohabitant de fait (Bruxelles)": "Conjoint/Ligne directe", "Ligne directe (Enfants/Parents)": "Conjoint/Ligne directe", "Frère/Sœur": "Frere/Sœur", "Oncle/Tante/Neveu/Nièce": "Oncle/Tante/Neveu/Niece", "Autres": "Autres" };
...
  //  🔴  PATCH v8.7.0 : Données OFFICIELLES Statbel étendues de Mars 2024 à Mars 2026
...
  // Février 2026 base 2025 = 101,84 -> base 2013 = 101,84/0,7376 = 138,07
  // Mars 2026 base 2025 = 101,63 -> base 2013 = 101,63/0,7376 = 137,78 (confirmé par indexsalaire.be)
  const loadDemoData = () => { 
...
            pebNote = "Bruxelles : L'indexation requiert un bail enregistré ET un certificat PEB valide. Indexation bloquée."; 
            blocked = true; 
          } 
          else if (/[EFG]/.test(idxPeb) && bruxFactorApplies) { 
            pebNote = "Bruxelles (bail < 14/10/2022 + PEB E/F/G) : Facteur de correction légal possible. Utilisez le calculateur officiel SPF pour le montant exact."; 
            needsOfficialCalculator = true; 
          } 
          else if (/[EFG]/.test(idxPeb)) { 
            pebNote = "Bruxelles (bail >= 14/10/2022) : Indexation standard sous réserve de bail enregistré et PEB communiqué."; 
          }
          else { 
            pebNote = "Bruxelles : Indexation autorisée à 100% (sous réserve de bail enregistré et PEB communiqué)."; 
          } 
        } else if (idxReg === "wallonie") { 
          if (idxPeb === "Inconnu / Sans PEB") {
            correctedAmount = baseRent;
            pebNote = "Wallonie : L'indexation requiert un bail enregistré ET un certificat PEB valide. Indexation bloquée.";
            blocked = true;
          }
          else if (/[DEFG]/.test(idxPeb)) { 
            pebNote = "Wallonie (PEB D/E/F/G) : Régime de calcul spécifique post-01/11/2023. Le montant exact doit être vérifié via le calculateur officiel SPF/Statbel."; 
            needsOfficialCalculator = true; 
          } 
          else { 
            pebNote = "Wallonie : Indexation autorisée à 100% (sous réserve d'enregistrement et demande écrite)."; 
          } 
        } else if (idxReg === "flandre") { 
          const leaseStart = idxLeaseStart ? new Date(idxLeaseStart) : null;
          const flandrePost2019 = leaseStart && leaseStart >= new Date("2019-01-01");
          pebNote = flandrePost2019 ? "Flandre (bail >= 01/01/2019) : Indice de base = mois précédant l'entrée en vigueur." : "Flandre (bail < 01/01/2019) : Indice de base = mois précédant la signature."; 
          if (/[DEFGI]/.test(idxPeb)) { 
            pebNote += " Un facteur de correction peut s'appliquer. Référez-vous à IndexSearch."; 
            needsOfficialCalculator = true; 
          } 
        } 
      } 
...
    if (sRel === "Cohabitant de fait (Flandre)" && sR !== "flandre") { setSRes({ taxHome: 0, taxOther: 0, totalTax: 0, rate: "0.00", home, other, total: home+other, sR, sRel,  advantageMode: "none", advantageNotCalculated: false, warning: "Cette catégorie n'est prévue ici que pour la Flandre." }); return; }
...
    if (sR === "flandre") {
      if (sRel === "Conjoint / Cohabitant légal") {
        if (sFlandreStraightLine) { warning = "Flandre : parenté en ligne directe = exclusion de l'avantage logement familial."; }
        else { applyExemptionToHome(); }
      } else if (sRel === "Cohabitant de fait (Flandre)") {
        if (!sFlandreFacto3ans) { warning = "Flandre : nécessite 3 ans de cohabitation ininterrompue."; }
...
        else { applyExemptionToHome(); }
      }
    } else if (sR === "wallonie" && sRel === "Conjoint / Cohabitant légal") {
      if (sFamWallonie5ans) { applyExemptionToHome(); } else { warning = "Wallonie : nécessite 5 ans de résidence principale (condition supprimée pour décès à partir de 2028)."; }
    } 
...
      if (sRel === "Conjoint / Cohabitant légal" && !sFamBruxellesExclu) { applyExemptionToHome(); }
      else if (sRel === "Cohabitant de fait (Bruxelles)") {
        if (sBruxCohab3yr) {
          warning = "Bruxelles : cohabitation de fait effective + ménage commun au moins 3 ans. Un tarif réduit sur le logement familial est possible, mais le montant exact dépend du régime légal applicable.";
          advantageMode = "reduced_rate";
          advantageNotCalculated = true;
        } 
        else if (sBruxCohab1yr) {
          warning = "Bruxelles : cohabitation de fait effective + ménage commun au moins 1 an. Tarif partenaire applicable (sans exonération du logement familial).";
...
  const doPension = () => { setPenErr(""); setPenRes(null); const r1 = penR1 === "" ? 0 : parseFloat(penR1); const r2 = penR2 === "" ? 0 : parseFloat(penR2); const n = parseInt(penN); const j = parseInt(penMode) || 0; const al = parseFloat(penAlloc) || 0; if (isNaN(r1) || r1 < 0 || isNaN(r2) || r2 < 0) { setPenErr("Les revenus doivent être des nombres positifs ou 0."); return; } if (!n || n <= 0) { setPenErr("Nombre d'enfants > 0."); return; } if (j < 0 || j > 365) { setPenErr("Jours entre 0 et 365."); return; } const ages = penA.split(",").map(a => parseInt(a.trim())).filter(a => !isNaN(a)); if (ages.length !== n) { setPenErr(`Entrez exactement ${n} âge(s).`); return; } setPenRes(calcRenard(r1, r2, n, ages, j, al, penAllocP)); };
...
          <div style={{ textAlign: "center", padding: "48px 0 52px" }}><h1 style={{ fontSize: 32, fontWeight: 700, margin: "0 0 10px", letterSpacing: -.5, background: "linear-gradient(135deg, #2D1E20 0%, #A65D67 60%, #8F4C55 100%)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent" }}>Votre droit, simplifié.</h1><p style={{ fontSize: 14, color: T.muted, fontFamily: "'Libre Franklin',sans-serif", maxWidth: 520, margin: "0 auto", lineHeight: 1.7 }}>Jurisprudence, doctrine, législation et outils d'orientation assistée pour les professionnels du droit belge.</p></div>
          <Divider label="Ressources Juridiques" />
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(260px,1fr))", gap: 12 }}>{[{ id: "jurisprudence", title: "Jurisprudence", desc: "Juportal, Lex.be, BelgiqueLex, Reflex et cours européennes." }, { id: "doctrine", title: "Doctrine & Recherche", desc: "Plateformes, bibliothèque filtrable." }, { id: "legislation", title: "Législation", desc: "Justel, Moniteur, EUR-Lex, codes consolidés, Livre IX 2026." }].map(s => (<Card key={s.id} onClick={() => setPg(s.id)} style={{ borderLeft: `3px solid ${T.dim}` }}><div style={{ fontSize: 17, fontWeight: 600, marginBottom: 4 }}>{s.title}</div><div style={{ fontSize: 12, color: T.muted, fontFamily: "'Libre Franklin',sans-serif", lineHeight: 1.6 }}>{s.desc}</div></Card>))}</div>
          <Divider label="Outils pratiques" color={T.pri} />
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(260px,1fr))", gap: 12 }}>{[{ id: "indexation", title: "Indexation (Loyer / Contrat)", desc: "Données officielles Statbel Mars 2024 - Mars 2026 (25 mois)." }, { id: "notariat", sub: "immo", title: "Achat immobilier", desc: "Vérification des conditions d'enregistrement régionales." }, { id: "notariat", sub: "succession", title: "Succession", desc: "Calculs intégrant les exonérations régionales." }, { id: "notariat", sub: "checklists", title: "Dossier Notarial", desc: "Checklists dynamiques." }, { id: "routier", title: "Infractions routières", desc: "Perception immédiate (SPF Mobilité)." }, { id: "preavis", title: "Simulateur de préavis", desc: "Barème SPF Emploi (exact post-2014, indicatif pré-2014)." }, { id: "pension", title: "Frais d'enfant", desc: "Estimation indicative (méthode Renard simplifiée)." }, { id: "fraisjustice", title: "Frais de justice", desc: "Indemnité de procédure (barème mars 2025)." }, { id: "juridometre", title: "Diagnostic de vigilance", desc: "Profil de risque et actions recommandées." }].map(s => (<Card key={s.title} onClick={() => { setPg(s.id); if (s.sub) setNotSub(s.sub); }} style={{ borderLeft: `3px solid ${T.pri}88` }}><div style={{ fontSize: 17, fontWeight: 600, marginBottom: 4 }}>{s.title}</div><div style={{ fontSize: 12, color: T.muted, fontFamily: "'Libre Franklin',sans-serif", lineHeight: 1.6 }}>{s.desc}</div></Card>))}</div>
          <Divider label="Apprendre" color={T.cyan} /><Card onClick={() => setPg("guide")} style={{ borderLeft: `3px solid ${T.cyan}` }}><div style={{ fontSize: 17, fontWeight: 600, marginBottom: 4 }}>Guide d'utilisation</div><div style={{ fontSize: 12, color: T.muted, fontFamily: "'Libre Franklin',sans-serif", lineHeight: 1.6 }}>Mode d'emploi, conseils et pièges à éviter.</div></Card>
        </div>)}
        {pg === "indexation" && (<div className="no-print"><SectionHead title="Indexation (Loyer & Contrats)" sub="Calcul d'indexation basé sur l'Indice Santé Statbel. Données officielles étendues : Mars 2024 à Mars 2026. Base 2013=100." />
          <Card><div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}><div><div style={{ fontSize: 16, fontWeight: 700 }}>Données officielles Statbel 2024-2026 (25 mois)</div><div style={{ fontSize: 13, color: T.muted, marginTop: 4 }}>Indices Santé de référence (Base 2013). v8.7.0 : extension jusqu'à Mars 2026 (valeurs 2026 converties depuis la nouvelle base 2025=100 via coef 0,7376).</div></div><button onClick={loadDemoData} disabled={idxApiState === "loading"} style={{ padding: "10px 18px", background: idxApiState === "loading" ? T.dim : T.priGrad, border: "none", borderRadius: 8, color: "white", fontFamily: "'Libre Franklin',sans-serif", fontSize: 13, fontWeight: 700, cursor: idxApiState === "loading" ? "wait" : "pointer" }}>{idxApiState === "loading" ? "Chargement..." : idxApiState === "success" ? "Données chargées" : "Charger les indices officiels"}</button></div>
            {idxApiState === "success" && (<div style={{ marginTop: 24, borderTop: `1px solid ${T.s3}`, paddingTop: 20 }}>
              <div style={{ marginBottom: 16 }}><label onClick={() => setIdxBail(!idxBail)} style={{ display: "flex", alignItems: "center", gap: 10, cursor: "pointer", fontFamily: "'Libre  Franklin',sans-serif", fontSize: 13 }}><div style={{ width: 20, height: 20, borderRadius: 5, background: idxBail ? T.green : T.s3, border: `1px solid ${idxBail ? T.green : T.bdr}`, display: "flex", alignItems: "center", justifyContent: "center", color: "white", fontSize: 12, fontWeight: 700 }}>{idxBail ? "\u2713" : ""}</div>Il s'agit d'un bail d'habitation (vérifications PEB régionales)</label></div>
              {idxBail && (<div style={{ marginBottom: 16, padding: 16, background: T.s2, borderRadius: 8, border: `1px solid ${T.bdr}` }}>
                <label style={{ fontFamily: "'Libre Franklin',sans-serif", fontSize: 11, color: T.muted, display: "block", marginBottom: 6 }}>Région du bien loué</label>
...
                {idxReg === "flandre" && (<div style={{ marginBottom: 16 }}><label style={{ fontFamily: "'Libre Franklin',sans-serif", fontSize: 11, color: T.muted, display: "block", marginBottom: 6 }}>Date d'entrée en vigueur du bail</label><Input type="date" value={idxLeaseStart} onChange={v => { setIdxLeaseStart(v); setIdxResult(null); }} /></div>)}
                {idxReg === "bruxelles" && (<div style={{ marginBottom: 16 }}><label style={{ fontFamily: "'Libre Franklin',sans-serif", fontSize: 11, color: T.muted, display: "block", marginBottom: 6 }}>Date d'entrée en vigueur du bail (pour facteur PEB)</label><Input type="date" value={idxLeaseStart} onChange={v => { setIdxLeaseStart(v); setIdxResult(null); }} /></div>)}
...
                {idxResult.blocked ? "Indexation bloquée" : idxResult.needsOfficialCalculator ? "Calcul spécifique requis" : "Règles d'indexation régionales"} :
              </strong>
...
                <li>L'indexation suppose un bail enregistré.</li>
                <li>L'effet rétroactif est limité aux 3 mois précédant la demande écrite.</li>
              </ul>
              {idxResult.blocked && <div style={{marginTop:8,padding:"6px 10px",background:T.red+"11",borderRadius:6,fontSize:10,color:T.red}}>Sans certificat PEB valide, l'indexation est juridiquement impossible dans cette région.</div>}
              {idxResult.needsOfficialCalculator && <div style={{marginTop:8,padding:"6px 10px",background:T.orange+"11",borderRadius:6,fontSize:10,color:T.orange}}>Pour ce cas, privilégiez le calculateur officiel SPF/Statbel pour un montant opposable.</div>}
            </div>
          )}<Disclaimer>Données Statbel officielles (API JSON). Pour la Wallonie et Bruxelles (PEB défavorables), privilégiez le calculateur officiel SPF/Statbel. Depuis janvier 2026, la base officielle est 2025=100 ; les valeurs 2026 sont converties ici en base 2013 via le coefficient 0,7376.</Disclaimer><SourceBadge type="Source" source="Statbel API (bestat.statbel.fgov.be)" bareme="Base 2013 - Mars 2024 à Mars 2026" /><PrintBtn /></Card>)}
        </div>)}
        {pg === "jurisprudence" && (<div className="no-print"><SectionHead title="Jurisprudence" sub="Bases de données officielles et plateformes gratuites (v8.7.0 : ajout de Lex.be, BelgiqueLex, Reflex)." />{JURIS.map(j => (<Card key={j.id}><div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", gap: 12 }}><div><div style={{ fontSize: 16, fontWeight: 600, marginBottom: 2 }}>{j.title}</div><div style={{ fontSize: 13, color: T.muted, fontFamily: "'Libre Franklin',sans-serif", marginBottom: 6 }}>{j.desc}</div><span style={{ fontFamily: "'Libre Franklin',sans-serif", fontSize: 9, color: T.pri, fontWeight: 700, textTransform: "uppercase" }}>{j.cat}</span></div>{j.url && <LinkBtn href={j.url}>Ouvrir</LinkBtn>}</div></Card>))}</div>)}
        {pg === "doctrine" && (<div className="no-print"><SectionHead title="Doctrine & Recherche" sub="Bibliothèque doctrinale structurée." />
          <div style={{ display: "flex", gap: 6, marginBottom: 20 }}>{[{ id: "biblio", l: "Bibliothèque" }, { id: "platforms", l: "Plateformes externes" }].map(s => (<Pill key={s.id} active={docSub === s.id} onClick={() => setDocSub(s.id)}>{s.l}</Pill>))}</div>
...
            <div style={{display:"flex",gap:12}}><div style={{flex:1}}><label style={{fontFamily:"'Libre Franklin',sans-serif",fontSize:11,color:T.muted,display:"block",marginBottom:4}}>Charges liées (EUR)</label><Input value={iCharges} onChange={v=>{setICharges(v);setIRes(null);}} type="number" placeholder="0"/></div><div style={{flex:1}}><label style={{fontFamily:"'Libre Franklin',sans-serif",fontSize:11,color:T.muted,display:"block",marginBottom:4}}>Valeur vénale estimée (EUR)</label><Input value={iValeurVenale} onChange={v=>{setIValeurVenale(v);setIRes(null);}} type="number" placeholder="Optionnel"/></div></div>
            <div><label style={{ fontFamily: "'Libre Franklin',sans-serif", fontSize: 11, color: T.muted, display: "block", marginBottom: 6 }}>Région</label><div style={{ display: "flex", gap: 6 }}>{["bruxelles", "flandre", "wallonie"].map(r => (<Pill key={r} active={iR === r} onClick={() => { setIR(r); setIRes(null); }} color={T.pri}>{rl[r]}</Pill>))}</div></div>
            <div style={{ background: T.s2, padding: 14, borderRadius: 8, border: `1px solid ${T.bdr}` }}><label style={{ fontFamily: "'Libre Franklin',sans-serif", fontSize: 11, fontWeight: 700, color: T.pri, display: "block", marginBottom: 10 }}>Conditions légales (taux réduit / abattement)</label>
              {[[iCondPhysique, setICondPhysique, "Achat par personne physique en pleine propriété totale"], [iCondPasAutre, setICondPasAutre, "Pas d'autre bien d'habitation (ou engagement de revente)"], [iCondDomicile, setICondDomicile, "Engagement de domiciliation (résidence principale)"]].map((o, i) => (<label key={i} onClick={() => { o[1](!o[0]); setIRes(null); }} style={{ display: "flex", alignItems: "center", gap: 10, cursor: "pointer", fontFamily: "'Libre Franklin',sans-serif", fontSize: 12, color: T.txt, marginBottom: 8 }}><div style={{ width: 20, height: 20, borderRadius: 5, background: o[0] ? T.cyan : T.s3, border: `1px solid ${o[0] ? T.cyan : T.bdr}`, display: "flex", alignItems: "center", justifyContent: "center", color: "white", fontSize: 12, fontWeight: 700 }}>{o[0] ? "\u2713" : ""}</div>{o[2]}</label>))}</div>
...
              <label onClick={()=>{setIFlandreFullOwnership(!iFlandreFullOwnership);setIRes(null);}} style={{display:"flex",alignItems:"center",gap:8,marginBottom:6,cursor:"pointer",fontFamily:"'Libre Franklin',sans-serif",fontSize:12}}><div style={{width:16,height:16,borderRadius:4,background:iFlandreFullOwnership?T.cyan:T.s3,border:`1px solid ${iFlandreFullOwnership?T.cyan:T.bdr}`,display:"flex",alignItems:"center",justifyContent:"center",color:"white",fontSize:10}}>{iFlandreFullOwnership?"\u2713":""}</div>Pleine propriété (pas usufruit/nue-propriété)</label>
...
            {[...(iRes.iN ? [] : [{ l: `Droits d'enregistrement (${iRes.conditionsMet && iRes.iR === "flandre" ? "2% (si cond. 2026)" : iRes.conditionsMet && iRes.iR === "wallonie" ? "3%" : iRes.conditionsMet && iRes.iR === "bruxelles" ? "12,5% + abattement" : "taux standard"})`, v: iRes.rr }]), ...(iRes.iN ? [{ l: "TVA 21%", v: iRes.tva }] : []), { l: "Honoraires notaire (indicatif simplifié)", v: iRes.nf }, { l: "TVA honoraires", v: iRes.nv }, { l: "Frais administratifs & débours", v: 1180 }].map((r, i) => (<div key={i} style={{ display: "flex", justifyContent: "space-between", padding: "10px 0", borderBottom: `1px solid ${T.s3}`, fontFamily: "'Libre Franklin',sans-serif", fontSize: 13 }}><span style={{ color: T.muted }}>{r.l}</span><span style={{ fontWeight: 600 }}>{fmt(r.v)}</span></div>))}
            <div style={{ display: "flex", justifyContent: "space-between", padding: "16px 0 4px" }}><span style={{ fontSize: 16, fontWeight: 700, color: T.pri }}>COÛT TOTAL ESTIMÉ</span><span style={{ fontSize: 22, fontWeight: 700, color: T.pri }}>{fmt(iRes.tot)}</span></div>
            {iR==="flandre" && !iRes.flandreCond2026?.natural && <div style={{padding:"8px 12px",background:T.orange+"08",border:`1px solid ${T.orange}44`,borderRadius:8,fontFamily:"'Libre Franklin',sans-serif",fontSize:11,color:T.orange,marginTop:12}}>Attention Flandre 2026 : le taux à 2% est strict. Toute condition non remplie fait basculer au 12%.</div>}
            <Disclaimer>Les frais de notaire sont indicatifs simplifiés. Le décompte final dépendra des recherches et formalités. Base taxable = max(prix + charges, valeur vénale).</Disclaimer><SourceBadge type="Source" source="SPF Finances / Régions" bareme="2025-2026" /><PrintBtn /></Card>)}</div>)}
...
                  <>Avantage légal potentiel détecté (<b>{sRes.advantageMode}</b>), mais <b>non chiffré</b> par ce simulateur.</>
                ) : (
                  <>Avantage appliqué : {sRes.advantageMode === "full_exemption" ? "Exonération totale (logement familial)" : sRes.advantageMode === "reduced_rate" ? "Tarif réduit progressif (logement familial)" : "Tarif partenaire"}</>
                )}
              </div>
            )}
            <Disclaimer>L'avantage s'applique UNIQUEMENT sur la part logement familial déclarée. Barèmes réduits v8.7.0 conformes aux sources officielles (notaire.be). Vérifiez les conditions régionales exactes auprès d'un notaire. Réformes Wallonie 2028 et Flandre 2026 non intégrées.</Disclaimer><SourceBadge type="Source" source="notaire.be (Fednot) / SPF Finances" bareme="Officiel 2024-2026" /><PrintBtn /></Card>)}</div>)}
...
              <div style={{ display: "flex", justifyContent: "space-between", padding: "8px 0", borderBottom: `1px solid ${T.s3}` }}><span style={{ color: T.muted }}>Dépassement</span><span style={{ fontWeight: 700, color: rRes.grave ? T.red : T.txt }}>+{parseInt(rSpeed) - parseInt(rLimit)} km/h</span></div>
              <div style={{ display: "flex", justifyContent: "space-between", padding: "12px 0 4px" }}><span style={{ fontSize: 16, fontWeight: 700 }}>PERCEPTION IMMÉDIATE THÉORIQUE</span><span style={{ fontSize: 22, fontWeight: 700 }}>{fmt(rRes.immFine)}</span></div>
              {rRes.exceedsCap && <div style={{padding:"8px 12px",background:T.red+"08",border:`1px solid ${T.red}44`,borderRadius:8,fontFamily:"'Libre Franklin',sans-serif",fontSize:11,color:T.red}}>Au-delà de 347 EUR, la perception immédiate est généralement exclue pour les résidents belges. Le dossier suivra une autre voie procédurale.</div>}
...
              <div style={{ display: "flex", justifyContent: "space-between", padding: "8px 0" }}><span style={{ color: T.muted }}>Déchéance</span><span style={{ fontWeight: 700, color: rRes.grave ? T.red : T.green }}>{rRes.dech}</span></div>
            </div><Disclaimer/><SourceBadge type="Source" source="SPF Mobilité / Police" bareme="Actuel" /><PrintBtn /></Card>)}</div>)}
        {pg === "preavis" && (<div><SectionHead title="Simulateur de préavis" sub="Barème SPF Emploi. Calcul exact pour les contrats post-2014, estimation indicative pour les contrats pré-2014." />
          <Card className="no-print"><div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
            <div style={{ display: "flex", gap: 12 }}><div style={{ flex: 1 }}><label style={{ fontFamily: "'Libre Franklin',sans-serif", fontSize: 11, color: T.muted, display: "block", marginBottom: 4 }}>Date début contrat</label><Input value={pStart} onChange={v => { setPStart(v); setPRes(null); }} type="date" /></div><div style={{ flex: 1 }}><label style={{  fontFamily: "'Libre Franklin',sans-serif", fontSize: 11, color: T.muted, display: "block", marginBottom: 4 }}>Date de notification</label><Input value={pNotifDate} onChange={v => { setPNotifDate(v); setPRes(null); }} type="date" /></div></div>
            <div><label style={{ fontFamily: "'Libre Franklin',sans-serif", fontSize: 11, color: T.muted, display: "block", marginBottom: 4 }}>Mode de notification</label><select value={pNotifType} onChange={e => { setPNotifType(e.target.value); setPRes(null); }} style={{ width: "100%", padding: "12px 16px", background: T.surface, border: `1px solid ${T.bdr}`, borderRadius: 10, color: T.txt, fontFamily: "'Libre Franklin',sans-serif", fontSize: 14, outline: "none" }}><option value="recommande">Lettre recommandée (+3 jours ouvrables)</option>{pDem ? (<><option value="main">Remise en main propre (effet direct)</option><option value="huissier">Exploit d'huissier (effet direct)</option></>) : (<option value="huissier">Exploit d'huissier (effet direct)</option>)}</select></div>
            <div><label style={{ fontFamily: "'Libre Franklin',sans-serif", fontSize: 11, color: T.muted, display: "block", marginBottom: 4 }}>Salaire brut ANNUEL complet (EUR) — 13e mois, pécule, avantages inclus</label><Input value={pSal} onChange={v => { setPSal(v); setPRes(null); }} type="number" placeholder="45000" /></div>
            {pSal && parseFloat(pSal) < 12000 && <div style={{ padding: "8px 12px", background: T.orange + "08", border: `1px solid ${T.orange}44`, borderRadius: 8, fontFamily: "'Libre Franklin',sans-serif", fontSize: 11, color: T.orange }}>Attention : ce montant semble être un salaire mensuel. Entrez le salaire brut ANNUEL complet (ex: 45.000 EUR).</div>}
            <div><label style={{ fontFamily: "'Libre Franklin',sans-serif", fontSize: 11, color: T.muted, display: "block", marginBottom: 6 }}>Initiative de la rupture</label><div style={{ display: "flex", gap: 6 }}>{[{ v: false, l: "Licenciement (employeur)" }, { v: true, l: "Démission (travailleur)" }].map(o => (<Pill key={o.l} active={pDem === o.v} onClick={() => { setPDem(o.v); setPRes(null); }}>{o.l}</Pill>))}</div></div>
            <label onClick={() => { setPOuv(!pOuv); setPRes(null); }} style={{ display: "flex", alignItems: "center", gap: 10, cursor: "pointer", fontFamily: "'Libre Franklin',sans-serif", fontSize: 13, opacity: pDem ? 0.4 : 1, pointerEvents: pDem ? "none" : "auto" }}><div style={{ width: 20, height: 20, borderRadius: 5, background: pOuv ? T.green : T.s3, border: `1px solid ${pOuv ? T.green : T.bdr}`, display: "flex", alignItems: "center", justifyContent: "center", color: "white", fontSize: 12, fontWeight: 700 }}>{pOuv ? "\u2713" : ""}</div>Statut ouvrier (ancien régime avant 2014) — ignoré en cas de démission</label>
...
              <div style={{ display: "flex", justifyContent: "space-between", padding: "8px 0", borderBottom: `1px solid ${T.s3}` }}><span style={{ color: T.muted }}>Ancienneté (jusqu'à la veille du préavis)</span><span style={{ fontWeight: 600 }}>{pRes.totalYears} ans ({pRes.totalMonths} mois)</span></div>
              {pRes.isDemission ? (<div style={{ display: "flex", justifyContent: "space-between", padding: "8px 0", borderBottom: `1px solid ${T.s3}` }}><span style={{ color: T.muted }}>Régime unique de démission</span><span style={{ fontWeight: 600 }}>{pRes.totalWeeks} semaines</span></div>) : (<>
                {pRes.weeksOld > 0 && <div style={{ display: "flex", justifyContent: "space-between", padding: "8px 0", borderBottom: `1px solid ${T.s3}` }}><span style={{ color: T.muted }}>Semaines ancien régime (estimation indicative)</span><span style={{ fontWeight: 600 }}>{pRes.weeksOld}</span></div>}
                <div style={{ display: "flex", justifyContent: "space-between", padding: "8px 0", borderBottom: `1px solid ${T.s3}` }}><span style={{ color: T.muted }}>Semaines nouveau régime</span><span style={{ fontWeight: 600 }}>{pRes.weeksNew}</span></div>
              </>)}
              <div style={{ display: "flex", justifyContent: "space-between", padding: "8px 0", borderBottom: `1px solid ${T.s3}` }}><span style={{ color: T.muted }}>Type</span><span style={{ fontWeight: 600, color: pRes.isDemission ? T.cyan : T.pri }}>{pRes.isDemission ? "Démission" : "Licenciement"}</span></div>
              {pRes.weeksOld > 0 && <div style={{ padding: "10px 14px", background: T.orange + "08", border: `1px solid ${T.orange}44`, borderRadius: 8, marginTop: 6, fontFamily: "'Libre Franklin',sans-serif", fontSize: 11, color: T.orange }}>Partie pré-2014 : estimation  non opposable. L'ancien régime distinguait plusieurs catégories. Vérification requise auprès d'un secrétariat social.</div>}
              <div style={{ display: "flex", justifyContent: "space-between", padding: "12px 0 4px" }}><span style={{ fontSize: 16, fontWeight: 700, color: T.pri }}>DÉLAI DE PRÉAVIS</span><span style={{ fontSize: 22, fontWeight: 700, color: T.pri }}>{pRes.totalWeeks} semaines</span></div>
              {pRes.isDemission && <div style={{ padding: "8px 12px", background: T.priDim, borderRadius: 8, fontFamily: "'Libre Franklin',sans-serif", fontSize: 11, color: T.muted }}>Démission plafonnée à 13 semaines maximum.</div>}
              <div style={{ display: "flex", justifyContent: "space-between", padding: "8px 0" }}><span style={{ color: T.muted }}>Indemnité de rupture</span><span style={{ fontSize: 18, fontWeight: 700, color: T.green }}>{fmt(pRes.indemnity)} brut</span></div>
            </div><Disclaimer/><SourceBadge type="Source" source="SPF Emploi" bareme="Régime de base" /><PrintBtn /></Card>)}</div>)}
        {pg === "pension" && (<div><SectionHead title="Estimation indicative des frais d'enfant" sub="Simulation interne inspirée des méthodes usuelles (Renard, barèmes indicatifs). Pas de calculateur officiel unique en Belgique." />
          <Card className="no-print"><div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
...
            <div style={{ display: "flex", gap: 12 }}><div style={{ flex: 1 }}><label style={{ fontFamily: "'Libre Franklin',sans-serif", fontSize: 11, color: T.muted, display: "block", marginBottom: 4 }}>Nombre d'enfants</label><Input value={penN} onChange={v => { setPenN(v); setPenRes(null); setPenErr(""); }} type="number" placeholder="2" /></div><div style={{ flex: 1 }}><label style={{ fontFamily: "'Libre Franklin',sans-serif",  fontSize: 11, color: T.muted, display: "block", marginBottom: 4 }}>Âges (virgule)</label><Input value={penA} onChange={v => { setPenA(v); setPenRes(null); setPenErr(""); }} placeholder="8, 12" /></div></div>
            <div><label style={{ fontFamily: "'Libre Franklin',sans-serif", fontSize: 11, color: T.muted, display: "block", marginBottom: 4 }}>Mode d'hébergement</label><select value={penMode} onChange={e => { setPenMode(e.target.value); setPenRes(null); }} style={{ width: "100%", padding: "12px 16px", background: T.s2, border: `1px solid ${T.bdr}`, borderRadius: 10, color: T.txt, fontFamily: "'Libre Franklin',sans-serif", fontSize: 14, outline: "none" }}><option value="182">Garde alternée (182j)</option><option value="300">Hébergement principal P1 (~300j)</option><option value="65">Hébergement principal P2 (P1 ~65j)</option><option value="100">Hébergement élargi P2 (P1 ~100j)</option></select></div>
            <div style={{ display: "flex", gap: 12 }}><div style={{ flex: 1 }}><label style={{ fontFamily: "'Libre Franklin',sans-serif", fontSize: 11, color: T.muted, display: "block", marginBottom: 4 }}>Allocations familiales</label><Input value={penAlloc} onChange={v => { setPenAlloc(v); setPenRes(null); setPenErr(""); }} type="number" placeholder="160" /></div><div style={{ flex: 1 }}><label style={{ fontFamily: "'Libre Franklin',sans-serif", fontSize: 11, color: T.muted, display: "block", marginBottom: 6 }}>Perçues par</label><div style={{ display: "flex", gap: 6 }}>{[{ v: 1, l: "P1" }, { v: 2, l: "P2" }].map(o => (<Pill key={o.v} active={penAllocP === o.v} onClick={() => { setPenAllocP(o.v); setPenRes(null); }}>{o.l}</Pill>))}</div></div></div>
            <button onClick={doPension} style={{ padding: 14, background: T.priGrad, border: "none", borderRadius: 10, color: "white", fontFamily: "'Libre Franklin',sans-serif", fontSize: 14, fontWeight: 700, cursor: "pointer" }}>Générer</button>
          </div></Card>
          {penRes && (<Card highlight isPrintable={true}><Divider label="Rapport — Frais d'enfant (indicatif)" color={T.pri} />
            <div style={{ fontFamily: "'Libre Franklin',sans-serif", fontSize: 13, display: "flex", flexDirection: "column", gap: 6 }}>
              <div style={{ display: "flex", justifyContent: "space-between", padding: "8px 0", borderBottom: `1px solid ${T.s3}` }}><span style={{ color: T.muted }}>Coût brut estimatif</span><span style={{ fontWeight: 600 }}>{fmt(penRes.costChildBrut)}/mois</span></div>
              <div style={{ display: "flex", justifyContent: "space-between", padding: "8px 0", borderBottom: `1px solid ${T.s3}` }}><span style={{ color: T.muted }}>Coût net (après allocations)</span><span style={{ fontWeight: 600 }}>{fmt(penRes.costChild)}/mois</span></div>
              <div style={{ display: "flex", justifyContent: "space-between", padding: "8px 0", borderBottom: `1px solid ${T.s3}` }}><span style={{ color: T.muted }}>Capacité P1 / P2</span><span style={{ fontWeight: 600 }}>{penRes.partP1}% / {penRes.partP2}%</span></div>
...
              <div style={{ padding: "8px 0", fontSize: 12, color: T.muted }}>À titre de simulation, la fourchette suggère qu'un transfert financier pourrait être discuté entre Parent {penRes.fromP1 ? "1" : "2"} et Parent {penRes.fromP1 ? "2" : "1"}.</div>
            </div><Disclaimer>Simulation interne non officielle. En Belgique, aucun barème légal obligatoire ne fixe la contribution alimentaire. Le juge statue au cas par cas selon les capacités financières et les besoins réels de l'enfant.</Disclaimer><SourceBadge type="Source" source="Méthode Renard (inspirée)" bareme="Indicatif" /><PrintBtn /></Card>)}</div>)}
        {pg === "fraisjustice" && (<div><SectionHead title="Baromètre des frais de justice" sub="Indemnité de procédure indexée au 1er mars 2025. Montant de base sans ajustement judiciaire." />
          <Card className="no-print"><div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
            <label onClick={() => { setFjNonEvaluable(!fjNonEvaluable); setFjRes(null); }} style={{ display: "flex", alignItems: "center", gap: 10, cursor: "pointer", fontFamily: "'Libre Franklin',sans-serif", fontSize: 13, color: T.pri, fontWeight: "bold" }}><div style={{ width: 20, height: 20, borderRadius: 5, background: fjNonEvaluable ? T.pri : T.s3, border: `1px solid ${fjNonEvaluable ? T.pri : T.bdr}`, display: "flex", alignItems: "center", justifyContent: "center", color: "white", fontSize: 12, fontWeight: 700 }}>{fjNonEvaluable ? "\u2713" : ""}</div>Affaire non évaluable en argent</label>
...
            <div><label style={{ fontFamily: "'Libre Franklin',sans-serif", fontSize: 11, color: T.muted, display: "block", marginBottom: 6 }}>Juridiction</label><div style={{ display: "flex", gap: 5, flexWrap: "wrap" }}>{[{ id: "paix", l: "Justice de paix" }, { id: "premiere", l: "Tribunal 1ère instance" }, { id: "entreprise", l: "Tribunal entreprise" }, { id: "appel", l: "Cour  d'appel" }].map(j => (<Pill key={j.id} active={fjJ === j.id} onClick={() => { setFjJ(j.id); setFjRes(null); }} color={T.pri}>{j.l}</Pill>))}</div></div>
            <label onClick={() => { setFjAcq(!fjAcq); setFjRes(null); }} style={{ display: "flex", alignItems: "center", gap: 10, cursor: "pointer", fontFamily: "'Libre Franklin',sans-serif", fontSize: 13 }}><div style={{ width: 20, height: 20, borderRadius: 5, background: fjAcq ? T.green : T.s3, border: `1px solid ${fjAcq ? T.green : T.bdr}`, display: "flex", alignItems: "center", justifyContent: "center", color: "white", fontSize: 12, fontWeight: 700 }}>{fjAcq ? "\u2713" : ""}</div>Acquiescement post-mise au rôle (1/4 de la base, max 1.400 EUR)</label>
...
          </div></Card>
          {fjRes && (<Card highlight isPrintable={true}><Divider label="Rapport — Risque procédural" color={T.pri} />
            {fjRes.jpWarning && <div style={{ padding: "10px 14px", background: T.red + "08", border: `1px solid ${T.red}22`, borderRadius: 8, marginBottom: 12, fontFamily: "'Libre Franklin',sans-serif", fontSize: 12, color: T.red }}>Compétence du Juge de paix généralement limitée à 5.000 EUR (sauf baux, copropriété).</div>}
...
            </div>
            <div style={{ padding: "12px 0", fontFamily: "'Libre Franklin',sans-serif", fontSize: 12, color: T.muted, marginTop: 12 }}>IP : {fmt(fjRes.ip)} {fjRes.isAcq ? "(acquiescement)" : fjRes.isNonEvaluable ? "(base non évaluable)" : `| min ${fmt(fjRes.ipMin)} | max ${fmt(fjRes.ipMax)}`}</div>
            <Disclaimer>Honoraires d'avocat non inclus. Le juge peut ajuster l'IP selon la complexité et les capacités financières. Privilégiez la résolution amiable.</Disclaimer><SourceBadge type="Source" source="Collège des cours et tribunaux" bareme="v1.0 (Mars 2025)" /><PrintBtn /></Card>)}</div>)}
        {pg === "juridometre" && (<div><SectionHead title="Diagnostic de vigilance" sub="Profil de risque et actions recommandées." />
...
            {jStep > 0 && <button onClick={() => setJStep(jStep - 1)} style={{ marginTop: 12, background: "none", border: "none", color: T.pri, cursor: "pointer", fontSize: 13, fontWeight: 600 }}>Précédent</button>}
          </div></Card>) : (
...
              </div></Card>
              <Card><div style={{ fontFamily: "'Libre Franklin',sans-serif", fontSize: 13, lineHeight: 1.7, color: T.muted }}><div style={{ marginBottom: 16, fontWeight: 600, color: T.txt, textTransform: "uppercase", letterSpacing: 1, fontSize: 11 }}>Actions recommandées :</div>{jResult.recs.map((r, i) => (<div key={i} style={{ marginBottom: 12, paddingBottom: 12, borderBottom: i < jResult.recs.length - 1 ? `1px solid ${T.s3}` : "none" }}><strong style={{ color: T.pri }}>{r.z} :</strong> {r.t}</div>))}</div></Card>
...
            </div>
          )}</div>)}
        {pg === "guide" && (<div className="no-print"><SectionHead title="Guide d'utilisation" sub="Mode d'emploi, conseils et pièges à éviter." /><GuideBlock sections={GUIDE_SECTIONS.filter(g => g.category === "juridique")} label="Sections juridiques" /><GuideBlock sections={GUIDE_SECTIONS.filter(g => g.category === "outils")} label="Outils pratiques" /></div>)}
      </div>
      <footer className="no-print" style={{ borderTop: "none", padding: "24px", background: "linear-gradient(180deg, #FCF6F6 0%, #FDF4F5 100%)", boxShadow: "0 -1px 12px rgba(166,93,103,0.04)" }}><div style={{ maxWidth: 700, margin: "0 auto", textAlign: "center" }}><div style={{ padding: "14px 18px", background: "rgba(255,255,255,0.7)", borderRadius: 10, marginBottom: 12, textAlign: "left", backdropFilter: "blur(4px)" }}><div style={{ fontFamily: "'Libre Franklin',sans-serif", fontSize: 9, fontWeight: 700, color: T.orange, textTransform: "uppercase", letterSpacing: 1, marginBottom: 4 }}>Orientation Assistée</div><p style={{ fontFamily: "'Libre Franklin',sans-serif", fontSize: 10, color: T.muted, lineHeight: 1.6, margin: 0 }}>Les informations et calculs sont fournis à titre d'orientation assistée. Ils ne constituent pas un avis juridique personnalisé. Consultez un professionnel du droit. Sources : Moniteur belge, SPF Justice, Justel, notaire.be (Fednot), SPF Mobilité, Statbel (API JSON), EUR-Lex. v8.7.0 - Avril 2026.</p></div><div style={{ fontFamily: "'Libre Franklin',sans-serif", fontSize: 9, color: T.dim, letterSpacing: 1 }}>JURATONE PRO v8.7.0 — PLATEFORME JURIDIQUE BELGE</div></div></footer>
    </div>
  );
}
